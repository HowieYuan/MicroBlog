	    ...
	    <div class="nav1"> 
		    <center>
		       ...
		       <form action='forgetPassword' onsubmit="return check()"> 
		                                邮箱地址:<input class="special" type='text' name='email' id="email" size="23" placeholder="为保证安全，请输入注册邮箱地址"   ><br><br>
		                                手机号码:<input class="special" type='text' name='phonenumber' id="phonenumber" size="23" placeholder="为保证安全，请输入注册手机号码"  ><br><br>      
		                                新 密 码:<input class="special" type='password' name='newpassword' id="newpassword" size="23" placeholder="密码：6到20位，数字和英文组成"  ><br><br>      
