		      ...
		      <center>  
		             ...
		             <form action='changeInformation' onsubmit="return check()">
		                  <table>
				                 ...
				                 <tr>
					                  <td> 昵 称:</td>
					                  <td><input class="special" type='text' name='username' id="username" size="20" placeholder="符号只能包含下划线" value=${sessionScope.login } ></td>
					             </tr>                                       
					             <tr>                                       
		                              <td>真实姓名:</td>
					             ...
					             <tr>                                        
					                  <td>性 别: </td>
					                  <td>
					                                                                  男：<input type="radio" name="sex" value="男" <c:if test="${sessionScope.vip.sex== '男'}">checked="checked"</c:if>/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					                                                                  女：<input type="radio" name="sex" value="女" <c:if test="${sessionScope.vip.sex== '女'}">checked="checked"</c:if>/>
					                  </td>
					             </tr>                                        
					             <tr>                                        
					                 <td>生 日:</td>
